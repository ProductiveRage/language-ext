...
namespace LanguageExt.Thunks
{
    ...
    {
        internal readonly Func<ThunkR<A>> fun;
        ...
        public static Thunk<A> Lazy(Func<ThunkR<A>> fun) =>
            new Thunk<A>(fun);
        ...
        public static Thunk<A> Lazy(Func<Fin<A>> fun) =>
            new Thunk<A>(() => ThunkR<A>.Result(fun()));

        /// <summary>
        /// Construct a lazy thunk
        /// </summary>
        [Pure, MethodImpl(Thunk.mops)]
        public static Thunk<A> Lazy(Func<A> fun) =>
            new Thunk<A>(() => ThunkR<A>.Succ(fun()));
